...
* Download the OpenIndiana 2G header file

[NOTE]
There are 2 different USB header files (1G and 2G).
The 1G is intended for use with the text installer (Command line console).
The 2G is intended for use with the live installer (Gnome desktop)
